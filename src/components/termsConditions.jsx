...
const TermsAndConditions = () => {
  return (
    <div id='#terms' style={{ paddingTop: '100px', maxWidth: '800px', margin: '0 auto', fontFamily: 'Arial, sans-serif', lineHeight: '1.6', paddingBottom: '50px' }}>
      <h1 style={{ textAlign: 'center', marginBottom: '20px' }}>TERMS AND CONDITIONS</h1>
      <p style={{ textAlign: 'center', fontStyle: 'italic' }}>Last updated November 11, 2024</p>

      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>AGREEMENT TO OUR LEGAL TERMS</h2>
      <p>
        We are Chaturdha Projects And Services Private Limited, doing business as CPS PVT LTD. Our application has been designed by the name of Bhawan Care, and Bhunan ("Company," "we," "us," "our"). Our GST number is 21AALCC7971L1Z8.
      </p>
      <p>
        We operate the mobile application Bhawan Care (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
        We provide a society management system where we give apartments the ability to use our app for simple, managed living through software.
      </p>
      <p>
        You can contact us by phone at <strong>1800-532-6114 </strong>, email at <strong>support@chaturdhaprojectsandservices.com </strong> , or by mail to N5/123, Radhamani Building, Bhubaneswar, Orissa 751013, India.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Chaturdha Projects And Services Private Limited, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
      </p>
      <p>
        We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <strong>support@chaturdhaprojectsandservices.com </strong>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
      </p>
      <p>
      ...
      <h3 style={{ marginBottom: '20px'}}>TABLE OF CONTENTS</h3>
      <ol style={{color: '#94664b'}}>
        <li>OUR SERVICES</li>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>1. OUR SERVICES</h2>
      <p>
        ...
        contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country.
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>2. INTELLECTUAL PROPERTY RIGHTS</h2>
      ...
      <p><strong>You are responsible for what you post or upload:</strong>By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt (in whole or in part), and exploit your Contributions (including, without limitation, your image, name, and voice) for any purpose, commercial, advertising, or otherwise, to prepare derivative works of, or incorporate into other works, your Contributions, and to sublicense the licenses granted in this section. Our use and distribution may occur in any media formats and through any media channels.</p>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>3. USER REPRESENTATIONS</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>4. USER REGISTRATION</h2>
      <p>You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password.
        We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
      </p>

      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>5. PURCHASES AND PAYMENT</h2>
      ...
      <p>You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services.
      ...
      <p>You agree to pay all charges at the prices then in effect for your purchases and any applicable shipping fees, and you authorize us to charge your chosen payment provider for any such amounts upon placing your order.
        We reserve the right to correct any errors or mistakes in pricing, even if we have already requested or received payment.
      </p>
      <p>We reserve the right to refuse any order placed through the Services. We may, in our sole discretion, limit or cancel quantities purchased per person, per household, or per order.
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>6. SUBSCRIPTIONS</h2>
      <h3>Billing and Renewal</h3>
      <p>Customer has to renew the subscription from their end through online payment method done by their own.</p>
      <h3>Cancellation</h3>
      <p>All purchases are non-refundable. You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at <strong><strong>support@chaturdhaprojectsandservices.com </strong> </strong>.</p>
      <h3>Fee Changes</h3>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>7. SOFTWARE</h2>
      <p>We may include software for use in connection with our Services. If such software is accompanied by an end user license agreement ("EULA"), the terms of the EULA will govern your use of the software.
        ...
        Any software and any related documentation is provided "AS IS" without warranty of any kind, either express or implied, including, without limitation, the implied warranties of merchantability, fitness for a particular purpose, or non-infringement.
        You accept any and all risk arising out of use or performance of any software.
        You may not reproduce or redistribute any software except in accordance with the EULA or these Legal Terms.
      </p>



      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>8. PROHIBITED ACTIVITIES</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>9. USER GENERATED CONTRIBUTIONS</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>10. CONTRIBUTION LICENSE</h2>
      <p>By posting your Contributions to any part of the Services or making Contributions accessible to the Services by linking your account from the Services to any of your social networking accounts, you automatically grant, and you represent and warrant that you have the right to grant,
        to us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive, store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>11. GUIDELINES FOR REVIEWS</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>12. MOBILE APPLICATION LICENSE</h2>
      <h3>Use License</h3>
      ...
      <p>The following terms apply when you use the App obtained from either the Apple Store or Google Play (each an "App Distributor") to access the Services:
        (1) the license granted to you for our App is limited to a non-transferable license to use the application on a device that utilizes the Apple iS or Android operating systems, as applicable, and in accordance with the usage rules set forth in the applicable App Distributor's terms of service;
        ...
        (5) you must comply with applicable third-party terms of agreement when using the App, e.g., if you have a VolP application, then you must not be in violation of their wireless data service agreement when using the App; and
        (6) you acknowledge and agree that the App Distributors are third-party beneficiaries of the terms and conditions in this mobile application license contained in these Legal Terms, and that each App Distributor will have the right (and will be deemed to have accepted the right) to enforce the terms and conditions in this mobile application license contained in these Legal Terms against you as a third-party beneficiary thereof.
      </p>


      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>13. SOCIAL MEDIA</h2>
      <p>As part of the functionality of the Services, you may link your account with online accounts you have with third-party service providers (each such account, a "Third-Party Account") by either:
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>14. THIRD-PARTY WEBSITES AND CONTENT</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>15. ADVERTISERS</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>16. SERVICES MANAGEMENT</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>17. PRIVACY POLICY</h2>
      <p>We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which is incorporated into these Legal Terms.
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>18. COPYRIGHT INFRINGEMENTS</h2>
      <p>We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately notify us using the contact information provided below (a "Notification").
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>19. TERM AND TERMINATION</h2>
      ...
      <p>If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party.
        In addition to terminating or suspending your account, we reserve the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.
      </p>


      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>20. MODIFICATIONS AND INTERRUPTIONS</h2>
      ...
      <p>We cannot guarantee the Services will be available at all times. We may experience hardware, software, or other problems or need to perform maintenance related to the Services, resulting in interruptions, delays, or errors.
        ...
        Nothing in these Legal Terms will be construed to obligate us to maintain and support the Services or to supply any corrections, updates, or releases in connection in connection therewith.
      </p>


      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>21. GOVERNING LAW</h2>
      <p>These Legal Terms shall be governed by and defined following the laws of India. Chaturdha Projects And Services Private Limited and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>


      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>22. DISPUTE RESOLUTION</h2>
      <p>You agree to irrevocably submit all disputes related to these Legal Terms or the legal relationship established by these Legal Terms to the jurisdiction of the India courts.</p>
      <p>Chaturdha Projects And Services Private Limited shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Legal Terms are entered into in the course of your trade or profession, the state of your principal place of business.</p>


      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>23. CORRECTIONS</h2>
      <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>

      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>24. DISCLAIMER</h2>
      <p>THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SERVICES WILL BE AT YOUR SOLE RISK.
        ...
        (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE DO NOT WARRANT, ENDORSE, GUARANTEE,
        OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES.
        AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.
      </p>


      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>25. LIMITATIONS OF LIABILITY</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>26. INDEMNIFICATION</h2>
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>27. USER DATA</h2>
      <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services.
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>28. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
      <p>Visiting the Services, sending us emails, and completing online forms constitute electronic communications.
       ...
       {/* <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>29. SMS TEXT MESSAGING</h2>
       <h3>Opting Out</h3>
       ...
       <h3>Support</h3>
       <p>If you have any questions or need assistance regarding our SMS communications, please email us at support@chaturdhaprojectsandservices.com  or call at 1800-532-6114.</p> */}


       {/* <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>30. CALIFORNIA USERS AND RESIDENTS</h2>
       <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Bivd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p> */}


      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>29. MISCELLANEOUS </h2>
      <p>These Legal Terms and any policies or operating rules posted by us on the Services or in respect to the Services constitute the entire agreement and understanding between you and us. 
      ...
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>30. CONTACT US</h2>
      <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
      <p>Chaturdha Projects And Services Private Limited</p>
      <p>N5/123, Radhamani Building bhubaneswar, Orissa 751013, India</p>
      <p><strong>Phone:</strong> 1800-532-6114</p>
      <p><strong>Mail:</strong> support@chaturdhaprojectsandservices.com </p>
